...
@section('admin')
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1><i class="fas fa-users"></i> SPJ Staff</h1>
        ...
        <section class="content">
            <!-- Default box -->
            <a href="{{ route('spj_tambah') }}" class="btn btn-sm btn-success mb-2"><i class="fas fa-plus"></i>
                Tambah
                Data</a>
                                ...
                                @foreach ($index as $i)
                                    <tr>
                                        <td style="width: 100px;">
                                            {{-- <a href="{{ route('spj_edit', $i->id) }}" class="btn btn-info">Edit</a> --}}
                                            <button type="button" class="btn btn-info"
                                                id="btnDetailSpj" data-id="{{ $i->id }}" onclick="modalSpjStaff({{ $i->id }})"><i class="fa fa-eye"></i> Detail</button>
                                            <form action="{{ route('spj_delete', $i->id) }}" method="POST">
                                                @csrf
                                                @method('delete')
