...
@section('title', 'Edit SPJ Kepala Dinas')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="nav-icon fas fa-copy"></i> Edit SPJ Kepala Dinas</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            <!-- Default box -->
            <form action="{{ route('proses_spj_kepala_edit', $edit->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                                        ...
                                        <fieldset style="border: 1px solid #ccc; padding: 15px;">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="hidden" name="total_riil" value="{{ $edit->total_riil }}"
                                                    id="inputanTotalRiil">
                                                <div style="font-size: 20px;">Total : Rp. <span id="totalRiil">{{ $edit->total_riil }}</span></div>
                                            </div>
                                        </fieldset>
                                    ...
                                    <fieldset style="border: 1px solid #ccc; padding: 15px;">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div style="font-size: 20px;">Total : Rp. <span
                                                    id="totalPerjalananDinas">{{ $edit->total_perjalanan_dinas }}</span></div>
                                        </div>
                                    </fieldset>
                                    <fieldset style="border: 1px solid #ccc; padding: 15px;">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-control" disabled name="kode_kegiatan" id="pilihKodeKegiatan"
                                                    required>
