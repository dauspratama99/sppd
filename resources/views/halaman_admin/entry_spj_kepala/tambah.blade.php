...
@section('title', 'Tambah SPJ Kepala Dinas')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="nav-icon fas fa-copy"></i> Tambah SPJ Kepala Dinas</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            ...
            <form action="{{ route('proses_spj_kepala_tambah') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card card-primary card-outline">
                                ...
                                <form action="" method="POST">
                                    <fieldset style="border: 1px solid #ccc; padding: 15px;">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-5">
                                                <select class="form-control" name="no_sppd" id="no_sppd" required>
                                                    ...
                                                    @php
                                                        $sppd = DB::table('surat_tugas_kepala')->get();
                                                    @endphp
                                                    @foreach ($sppd as $t)
                                        ...
                                        <fieldset style="border: 1px solid #ccc; padding: 15px;">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <input type="text" name="tujuan_bandara_terminal"
                                                            id="tujuanBandaraTerminal" class="form-control form-control-sm"
                                                            required>
                                                    </div>
                                                    <div class="col-sm-1">
                                                        <button type="button" class="btn btn-dark btn-sm"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <input type="text" name="bandara_terminal_tinggal"
                                                            id="bandaraTerminaltinggal" class="form-control form-control-sm"
                                                            required>
                                                    </div>
                                                    <div class="col-sm-1">
                                                        <button type="button" class="btn btn-dark btn-sm"
                                                ...
                                                <div class="mb-3 row">
                                                    <label for="biayaHotel" class="col-sm-5 col-form-label">5. Biaya Hotel
                                                        30% </label>
                                                    <div class="col-sm-2">
                                                        <input type="text" name="biaya_hotel" id="biayaHotel"
                                                            class="form-control form-control-sm" required>
                                                    </div>
                                                    <div class="col-sm-1">
                                                        <button type="button" class="btn btn-dark btn-sm"
                                            ...
                                            <div class="col-sm-12">
                                                <input type="hidden" name="total_riil" id="inputanTotalRiil">
                                    ...
                                    <fieldset style="border: 1px solid #ccc; padding: 15px;">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" name="biaya_transportasi_darat"
                                                    id="biayaTransportasiDarat" class="form-control form-control-sm"
                                                    required>
                                            </div>
                                        ...
                                        <div class="mb-3 row">
                                            <label for="biayaBahanBakar" class="col-sm-3 col-form-label">4. Biaya Bahan
                                                Bakar </label>
                                            <div class="col-sm-2">
                                                <input type="text" name="biaya_bahan_bakar" id="biayaBahanBakar"
                                                    class="form-control form-control-sm">
                                            </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" name="daftar_pernyataan" id="daftarPernyataan"
                                                    class="form-control form-control-sm" required>
                                            </div>
                                    ...
                                    <fieldset style="border: 1px solid #ccc; padding: 15px;">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-control" name="kode_kegiatan" id="pilihKodeKegiatan"
                                                    ...
                                                    @php
                                                        $kegiatan = DB::table('program_kerja_kepala')->get();
                                                    @endphp
                                        ...
                                        <div class="mb-3 row">
                                            <label for="kodeRekening" class="col-sm-2 col-form-label">Kode Rekening</label>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <textarea name="keperluan" id="keperluan" cols="30" rows="3"
                                                    class="form-control" required readonly></textarea>
                                            </div>
                                            @error('keperluan')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                            ...
                                            <div class="mb-3 row ml-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="keberangkatan_kode_booking"
                                                        id="keberangkatan_kodeBooking" class="form-control" required>
                                                </div>
                                            ...
                                            <div class="mb-3 row ml-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="keberangkatan_nomor_tiket"
                                                        id="keberangkatan_nomorTiket" class="form-control" required>
                                                </div>
                                            ...
                                            <div class="mb-3 row ml-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="keberangkatan_nomor_seat"
                                                        id="keberangkatan_nomorSeat" class="form-control" required>
                                                </div>
                                            ...
                                            <div class="mb-3 row ml-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="keberangkatan_nomor_flight"
                                                        id="keberangkatan_nomorFlight" class="form-control" required>
                                                </div>
                                            ...
                                            <div class="mb-3 row ml-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="kedatangan_kode_booking"
                                                        id="kedatangan_kodeBooking" class="form-control" required>
                                                </div>
                                            ...
                                            <div class="mb-3 row ml-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="kedatangan_nomor_tiket"
                                                        id="kedatangan_nomorTiket" class="form-control" required>
                                                </div>
                                            ...
                                            <div class="mb-3 row ml-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="kedatangan_nomor_seat"
                                                        id="kedatangan_nomorSeat" class="form-control" required>
                                                </div>
                                            ...
                                            <div class="mb-3 row ml-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="kedatangan_nomor_flight"
                                                        id="kedatangan_nomorFlight" class="form-control" required>
                                                </div>
                                    ...
                                    <fieldset style="border: 1px solid #ccc; padding: 15px;">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="nama_hotel" id="namaHotel" class="form-control"
                                                    required>
                                            </div>
                                            @error('nama_hotel')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                    ...
                                    <fieldset style="border: 1px solid #ccc; padding: 15px;">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="file" name="dokumen_pendukung" id="dokumenPendukung" required>
                                            </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('kelola_spj_kepala') }}" class="btn btn-warning">Back</a>
                    </div>
                </div>
            </form>
        </section>
        ...
        $(document).ready(function() {
            ...
            function tingkatan_a() {
                $("#table_content_a tbody").dblclick(function(e) {
                    ...
                    let totharga = parseInt(harga * durasi * 0.3)

                    $("#biayaHotel").val(totharga);
            ...
            $("#pilihKodeKegiatan").change(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(parseInt(pengeluaran) > parseInt(nilai)){
                            alert('Maaf Nilai Kegiatan tidak mencukupi ! Silahkan pilih kegiatan lain..')
                            $("#nilaiKegiatan").val(response.nilai)
                            $("#kodeRekening").val(response.kode_rekening)
                        }else{
                            $("#nilaiKegiatan").val(response.nilai)
                            $("#kodeRekening").val(response.kode_rekening)
                            $("#sisaNilaiKegiatan").val(total ? total : "")
                        }
                    }
                });
            })
