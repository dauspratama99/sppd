<div class="modal fade" id="modalTransportBandaraTerminalTinggal" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="table-responsive">
          <table class="table table-bordered overflow-auto" id="table_content4" style="display:block; width: 100%; height: 200px;">
        ...
        <div class="table-responsive">
            <table class="table table-bordered overflow-auto" id="table_content_terminal4" style="display:block; width: 100%; height: 120px;">
                <thead class="d-block w-100">
                    <tr class="d-flex w-100">
                      <th class="w-50">PROVINSI</th>
                      <th class="w-25">SATUAN</th>
