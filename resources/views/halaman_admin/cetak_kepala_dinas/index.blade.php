            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1><i class="fas fa-users"></i> Cetak SPJ Kepala Dinas</h1>
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <form class="form-inline">
                        ...
                        <div class="form-group mx-sm-3 mb-2">
                            <a href="{{ route('export_spj_kepala_dinas', @$_GET['jenis_perjalanan']) }}" class="btn btn-success"><i class="fas fa-download"></i> Export Excel</a>
                        </div>
                    </form>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($cetak as $i)
                                    <tr class="text-center">
                                        <td style="width: 100px;">
                                            <a href="{{ route('cetak_kepala_dinas2', $i->id_spj) }}"
                                                class="btn btn-sm btn-success mb-2" target="_blank"><i class="fas fa-print"></i>
                                                Cetak</a>
                                            <button type="button" class="btn btn-info" id="btnDetailSpjKepala"
                                                data-id="{{ $i->id_spj }}" onclick="modalSpjKepala({{ $i->id_spj }})"><i class="fa fa-eye"></i> Detail</button>
                                        </td>
