...
@section('title', 'Cetak Surat Tugas Staff')
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1><i class="fas fa-users"></i> Cetak Surat Tugas</h1>
        ...
        <section class="content">
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <div class="card-title">Cetak Surat Tugas</div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered" id="example1">
                            ...
                            <tbody>
                                @foreach ($index as $i)
                                    <tr>
                                        <td>
                                            <a href="{{ route('cetak_surat', $i->id) }}"
                                                class="btn btn-sm btn-success mb-2 btn-block" target="blank"><i
                                                    class="fas fa-print"></i>
                                                Surat Tugas</a>

                                            <a href="{{ route('cetak_surat_staf', $i->id) }}"
                                                class="btn btn-sm btn-success mb-2 btn-block" target="blank"><i
                                                    class="fas fa-print"></i>
                                                Surat SPPD</a>
                                        </td>
