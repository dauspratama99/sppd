...
@section('admin')
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1><i class="nav-icon fas fa-copy"></i> Program Kegiatan Staff</h1>
        ...
        <section class="content">
            <!-- Default box -->
            <a href="{{ route('program_tambah') }}" class="btn btn-sm btn-success mb-2"><i class="fas fa-plus"></i>
                Tambah
                Data</a>
                            ...
                            <tbody>
                                @foreach ($index as $i)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a href="{{ route('program_edit', $i->id) }}"
                                                class="btn btn-block btn-info mb-2"><i class="fas fa-edit"></i>Edit</a>
                                            <form action="{{ route('program_hapus', $i->id) }}" method="post">
                                                @method('delete')
                                                @csrf
