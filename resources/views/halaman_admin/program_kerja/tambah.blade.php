...
@section('title', 'Tambah Kegiatan Staff')
...
@section('admin')
    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1><i class="nav-icon fas fa-copy"></i> Tambah Program Kegiatan Staff</h1>
        ...
        <section class="content">
            ...
            <form action="{{ route('proses_program_tambah') }}" method="POST">
                @csrf
