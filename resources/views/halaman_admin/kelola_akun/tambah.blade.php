...
@section('admin')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form action="{{ route('proses_akun_tambah') }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomor_hp" class="form-control form-control-sm" required>
                                    @error('email')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="id_tipe" aria-label="Default select example">
                                        <option>Pilih Status</option>
                                        @foreach ($tipe_user as $tipe ) --}}
                                        <option value="{{ $tipe->id_tipe }}">{{ $tipe->user_tipe }}</option>
                                     @endforeach
                                    </select>
                                </div>
