...
@section('title', 'Surat Tugas Kepala Dinas')
...
@section('admin')
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1><i class="fas fa-copy"></i> Surat Tugas Kepala Dinas</h1>
        ...
        <section class="content">
            <!-- Default box -->
            <a href="{{ route('surattugaskepala_tambah') }}" class="btn btn-sm btn-success mb-2"><i class="fas fa-plus"></i>
                Tambah
                Data</a>
                        ...
                        <table class="table table-bordered" id="example1">
                            ...
                            <tbody>
                                @foreach ($index as $i)
                                    <tr>
                                        <td>
                                            <a href="{{ route('surattugaskepala_edit', $i->id_surat_tugas) }}"
                                                class="btn btn-sm btn-warning mb-2"><i class="fas fa-edit"></i>Edit</a>
                                            &nbsp;&nbsp;
                                            <form action="{{ route('surattugaskepala_hapus', $i->id_surat_tugas) }}" method="post">
                                                @method('delete')
                                                @csrf
