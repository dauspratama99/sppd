...
@section('title', 'Edit Surat Tugas Kepala Dinas')
...
@section('admin')
    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1><i class="nav-icon fas fa-copy"></i> Edit Surat Tugas Kepala Dinas</h1>
        ...
        <section class="content">
            <!-- Default box -->
            <form action="{{ route('proses_surattugaskepala_edit', $edit->id_surat_tugas) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <div class="card-title">Surat Tugas Kepala Dinas {{ $edit->no_surat_tugas }}</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <label for=""> &nbsp; </label>
                                        <input type="text" name="no_surat_tugas2" value="/ST/SETDA-III/2021"
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" name="no_sppd" value="{{ $edit->surat_tugas }}"
                                            class="form-control" placeholder="Nomor Sppd">
                                        @error('no_sppd')
                                            <div class="alert alert-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col">
                                        <label for=""> &nbsp; </label>
                                        <input type="text" name="no_sppd2" value="/ST/SETDA-III/2021"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex">
                                        <input type="text" name="nama" id="nama" class="form-control form-control-sm" value="{{ $edit->nama_lengkap }}" readonly>
                                        &nbsp;&nbsp;
                                ...
                                <div class="form-group">
                                    <label for="">NIP</label>
                                    <input type="text" name="nip" id="nip" class="form-control form-control-sm" value="{{ $edit->nip }}" readonly>
                                    @error('nip')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jabatan" id="jabatan" class="form-control form-control-sm" value="{{ $edit->jabatan }}" readonly>
                                    @error('jabatan')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
