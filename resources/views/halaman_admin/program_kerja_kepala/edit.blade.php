...
@section('title', 'Edit Kegiatan Kepala Dinas')
...
@section('admin')
    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1><i class="nav-icon fas fa-copy"></i> Edit Program Kegiatan Kepala Dinas</h1>
        ...
        <section class="content">
            ...
            <form action="{{ route('proses_program_kepala_edit', $edit->id) }}" method="POST">
                @csrf
