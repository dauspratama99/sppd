    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="fas fa-users"></i> Edit Pegawai</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            <form action="{{ route('proses_pegawai_edit', $edit->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="tingkat_biaya" aria-label="Default select example">
                                        <option value="">{{ $edit->tingkat_biaya }}</option>
                                        @php
                                            $biaya = ['A', 'B', 'C', 'D', 'E', 'F'];
                                        @endphp
                                        @foreach ($biaya as $b)
