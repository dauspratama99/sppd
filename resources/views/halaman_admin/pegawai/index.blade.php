...
@section('admin')
    <div class="content-wrapper">
        ...
        <section class="content">
            <!-- Default box -->
            <a href="{{ route('pegawai_tambah') }}" class="btn btn-sm btn-success mb-2"><i class="fas fa-plus"></i> Tambah
                Data</a>
                            ...
                            <tbody>
                                @foreach ($index as $i)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a href="{{ route('pegawai_edit', $i->id) }}"
                                                class="btn btn-block btn-info mb-2"><i class="fas fa-edit"></i> <br>
                                                Edit</a>
                                            <form action="{{ route('pegawai_delete', $i->id) }}" method="post">
                                                @method('delete')
                                                @csrf
