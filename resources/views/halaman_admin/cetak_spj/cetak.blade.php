    ...
    <center>
        <div style="height: 100vh;">
            ...
            <table width="90%">
                ...
                <tr>
                    <td> <u><b>{{ strtoupper($kepala->nama_lengkap) }}</b></u><br>Nip: {{ $kepala->nip }} </td>
        ...
        <div style="height: 100vh;">
            ...
            <table width="90%">
                <tr>
                    ...
                    <td width="900" style="text-align:right;"> Mamuju, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2021 <br>
                        Telah Menerima
                        Jumlah
            ...
            <table width="90%"><br><br><br><br>
                <br>
                <tr>
                    <td width="150" style="vertical-align: top;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td width="900" style="font-family: Arial; font-size:11; text-align:right;"> <b><u>{{ strtoupper($kepala->nama_lengkap) }}</u>
                        </b> <br> Nip: {{ $kepala->nip }} </td>
                </tr>
            </table>
            <br><br><br><br>
        </div>
            ...
            <table width="90%" style="margin: 0 auto;">
                <tr>
                    <td width="964"> Mengetahui / Menyetujui
                        ...
                        <br><br><br><br><br><br>
                        <u> <b>{{ strtoupper($kepala->nama_lengkap) }}</b></u>
                        <br>Nip: {{ $kepala->nip }}
                    </td>
