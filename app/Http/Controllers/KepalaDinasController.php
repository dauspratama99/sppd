...
class KepalaDinasController extends Controller
{
    ...
    {
        $index = KepalaDinas::all();
        return view('halaman_admin.kepala_dinas.index', compact('index'));
    }
    ...
    {
        return view('halaman_admin.kepala_dinas.tambah');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kelola_kepala_dinas');
    }
    ...
    {
        $edit = KepalaDinas::find($id);
        return view('halaman_admin.kepala_dinas.edit', compact('edit'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $update = KepalaDinas::find($request->id);
